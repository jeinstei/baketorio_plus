...
if feature_flags["spoiling"] then
	...
	rsl.register_spoilable_item(calf)
...
add exotic alien fruit for alien fruit tarts for alien baking science, which unlock character abilities (like longer reach and faster speed)
